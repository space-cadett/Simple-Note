...
document.querySelector("#note-form").addEventListener("submit", (e) => {
  ...
  const color = document.querySelector(".swatches").querySelector(".active")
    .classList[0];
...
document.querySelector("#note-list").addEventListener("click", (e) => {
  ...
  if (e.target.classList.contains("fa-pencil-alt")) {
    ...
    document.querySelector(
      "#title"
    ).value = e.target.parentElement.firstElementChild.innerText.trim();
    document.querySelector(
      "#content"
    ...
    document
      .querySelector(
        "." +
          e.target.parentElement.parentElement.querySelector(".card-body")
            .classList[1]
      )
